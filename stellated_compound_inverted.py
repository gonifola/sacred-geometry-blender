...
# TIP_DOD = 2.618034 (LONG), TIP_ICO = 1.618034 (SHORT)
# Inverted variant: tall dodecahedron spikes + stubby icosahedron spikes
...
verts = [
    ...
    (0.5000000000, 0.0000000000, 1.3090169944),
    (1.3090169944, 0.5000000000, 0.0000000000),
    (0.0000000000, 2.0192708931, 3.2672489377),
    (3.2672489377, 0.0000000000, 2.0192708931),
    (2.0192708931, 3.2672489377, 0.0000000000),
    (0.0000000000, -2.0192708933, 3.2672489376),
    (3.2672489376, 0.0000000000, -2.0192708933),
    (-3.2672489377, 0.0000000000, 2.0192708931),
    (-3.2672489376, 0.0000000000, -2.0192708933),
    (0.0000000000, -2.0192708933, -3.2672489376),
    (-2.0192708931, -3.2672489377, 0.0000000000),
    (0.0000000000, 2.0192708931, -3.2672489377),
    (-2.0192708933, 3.2672489376, 0.0000000000),
    (2.0192708931, -3.2672489377, 0.0000000000),
...
mesh = bpy.data.meshes.new("Compound_Inverted")
mesh.from_pydata(verts, [], faces)
mesh.update(calc_edges=True)
mesh.validate(verbose=True)

obj = bpy.data.objects.new("Stellated_Compound_Inverted", mesh)
...
# Export STL
import os
stl_path = os.path.expanduser('~/Desktop/stellated_compound_inverted.stl')
try:
